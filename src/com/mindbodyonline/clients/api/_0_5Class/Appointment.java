    ...
    extends ScheduleItem
{
    ...
    @XmlElementRef(name = "StaffRequested", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "FirstAppointment", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
