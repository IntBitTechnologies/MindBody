    ...
    extends MBObject
{
    ...
    @XmlElementRef(name = "BusinessID", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "FacilitySquareFeet", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> facilitySquareFeet;
    @XmlElementRef(name = "TreatmentRooms", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Tax1", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Float> tax1;
    @XmlElementRef(name = "Tax2", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Float> tax2;
    @XmlElementRef(name = "Tax3", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Float> tax3;
    @XmlElementRef(name = "Tax4", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Float> tax4;
    @XmlElementRef(name = "Tax5", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Latitude", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> latitude;
    @XmlElementRef(name = "Longitude", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> longitude;
    @XmlElementRef(name = "DistanceInMiles", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> distanceInMiles;
    @XmlElement(name = "ImageURL")
    protected String imageURL;
    @XmlElement(name = "Description")
    protected String description;
    @XmlElementRef(name = "HasSite", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> hasSite;
    @XmlElementRef(name = "CanBook", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
