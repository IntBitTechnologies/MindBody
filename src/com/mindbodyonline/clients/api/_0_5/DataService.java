 ...
 * 
 */
@WebServiceClient(name = "DataService", targetNamespace = "http://clients.mindbodyonline.com/api/0_5", wsdlLocation = "https://api.mindbodyonline.com/0_5/DataService.asmx?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DATASERVICE_QNAME = new QName("http://clients.mindbodyonline.com/api/0_5", "DataService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://api.mindbodyonline.com/0_5/DataService.asmx?wsdl");
     ...
     * 
     * @return
     *     returns DataServiceSoap
     */
    @WebEndpoint(name = "DataServiceSoap")
    public DataServiceSoap getDataServiceSoap() {
        return super.getPort(new QName("http://clients.mindbodyonline.com/api/0_5", "DataServiceSoap"), DataServiceSoap.class);
    }
    ...
    public DataServiceSoap getDataServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://clients.mindbodyonline.com/api/0_5", "DataServiceSoap"), DataServiceSoap.class, features);
    }
