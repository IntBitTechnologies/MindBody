...
@XmlSeeAlso({
    GetLocationsResult.class,
    GetProgramsResult.class,
    GetResourcesResult.class,
    GetSitesResult.class,
    GetSessionTypesResult.class,
    ReserveResourceResult.class,
    GetActivationCodeResult.class,
    GetRelationshipsResult.class,
    GetResourceScheduleResult.class
})
