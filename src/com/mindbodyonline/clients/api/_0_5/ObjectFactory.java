...
public class ObjectFactory {
    ...
    private final static QName _LocationID_QNAME = new QName("http://clients.mindbodyonline.com/api/0_5", "ID");
    ...
    public JAXBElement<Integer> createLocationID(Integer value) {
        return new JAXBElement<Integer>(_LocationID_QNAME, Integer.class, Location.class, value);
    }
    ...
    public JAXBElement<Integer> createResourceID(Integer value) {
        return new JAXBElement<Integer>(_LocationID_QNAME, Integer.class, Resource.class, value);
    }
    ...
    public JAXBElement<Integer> createSessionTypeID(Integer value) {
        return new JAXBElement<Integer>(_LocationID_QNAME, Integer.class, SessionType.class, value);
    }
