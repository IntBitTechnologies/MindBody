 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://clients.mindbodyonline.com/api/0_5}Item">
 *       &lt;sequence>
 ...
 *         &lt;element name="Color" type="{http://clients.mindbodyonline.com/api/0_5}Color" minOccurs="0"/>
 *         &lt;element name="Size" type="{http://clients.mindbodyonline.com/api/0_5}Size" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Item
{
    ...
    @XmlElementRef(name = "Price", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> price;
    @XmlElementRef(name = "TaxIncluded", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElement(name = "ID")
    protected String id;
    @XmlElementRef(name = "GroupID", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> groupID;
    @XmlElement(name = "Name")
    protected String name;
    @XmlElementRef(name = "OnlinePrice", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
