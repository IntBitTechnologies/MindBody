...
@XmlSeeAlso({
    GetPackagesResult.class,
    GetSalesResult.class,
    CheckoutShoppingCartResult.class,
    GetCustomPaymentMethodsResult.class,
    GetAcceptedCardTypeResult.class,
    RedeemSpaFinderWellnessCardResult.class,
    GetServicesResult.class,
    GetProductsResult.class,
    UpdateProductsResult.class,
    UpdateServicesResult.class
})
