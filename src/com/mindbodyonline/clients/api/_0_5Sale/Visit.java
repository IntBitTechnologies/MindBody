    ...
    extends MBObject
{
    ...
    @XmlElementRef(name = "SignedIn", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> signedIn;
    @XmlElementRef(name = "MakeUp", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
