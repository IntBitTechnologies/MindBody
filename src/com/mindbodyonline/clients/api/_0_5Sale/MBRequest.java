...
@XmlSeeAlso({
    GetPackagesRequest.class,
    GetAcceptedCardTypeRequest.class,
    CheckoutShoppingCartRequest.class,
    GetSalesRequest.class,
    GetServicesRequest.class,
    RedeemSpaFinderWellnessCardRequest.class,
    GetCustomPaymentMethodsRequest.class,
    GetProductsRequest.class,
    UpdateProductsRequest.class,
    UpdateServicesRequest.class
})
