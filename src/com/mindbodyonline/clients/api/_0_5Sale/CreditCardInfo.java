 ...
 *         &lt;element name="SaveInfo" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends PaymentInfo
{
    ...
    @XmlElementRef(name = "Amount", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "SaveInfo", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> saveInfo;
    ...
    /**
     * Gets the value of the saveInfo property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Boolean> getSaveInfo() {
        return saveInfo;
    }

    /**
     * Sets the value of the saveInfo property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setSaveInfo(JAXBElement<Boolean> value) {
        this.saveInfo = value;
    }
