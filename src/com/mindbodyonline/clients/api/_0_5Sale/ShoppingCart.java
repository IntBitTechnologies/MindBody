 ...
 *         &lt;element name="CartItems" type="{http://clients.mindbodyonline.com/api/0_5}ArrayOfCartItem" minOccurs="0"/>
    ...
    extends MBObject
{
    ...
    @XmlElementRef(name = "SubTotal", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> subTotal;
    @XmlElementRef(name = "DiscountTotal", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> discountTotal;
    @XmlElementRef(name = "TaxTotal", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> taxTotal;
    @XmlElementRef(name = "GrandTotal", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
