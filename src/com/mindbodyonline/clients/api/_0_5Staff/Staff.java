    ...
    extends MBObject
{
    ...
    @XmlElementRef(name = "MultiLocation", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> multiLocation;
    @XmlElementRef(name = "AppointmentTrn", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> appointmentTrn;
    @XmlElementRef(name = "ReservationTrn", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> reservationTrn;
    @XmlElementRef(name = "IndependentContractor", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> independentContractor;
    @XmlElementRef(name = "AlwaysAllowDoubleBooking", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
