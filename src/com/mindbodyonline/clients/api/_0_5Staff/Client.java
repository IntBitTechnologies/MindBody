    ...
    extends MBObject
{
    ...
    @XmlElementRef(name = "IsCompany", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> isCompany;
    @XmlElementRef(name = "Inactive", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "LiabilityRelease", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PromotionalEmailOptIn", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "EmailOptIn", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "BirthDate", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> birthDate;
    @XmlElementRef(name = "FirstAppointmentDate", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "IsProspect", namespace = "http://clients.mindbodyonline.com/api/0_5", type = JAXBElement.class, required = false)
