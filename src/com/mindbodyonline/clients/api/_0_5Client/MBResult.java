...
@XmlSeeAlso({
    AddOrUpdateContactLogsResult.class,
    UpdateClientServicesResult.class,
    GetActiveClientMembershipsResult.class,
    GetClientAccountBalancesResult.class,
    DeleteClientFormulaNoteResult.class,
    GetClientIndexesResult.class,
    GetClientPurchasesResult.class,
    GetCustomClientFieldsResult.class,
    ClientSendUserNewPasswordResult.class,
    GetClientsResult.class,
    GetClientScheduleResult.class,
    GetContactLogTypesResult.class,
    AddOrUpdateClientsResult.class,
    AddClientFormulaNoteResult.class,
    GetClientVisitsResult.class,
    UploadClientDocumentResult.class,
    GetClientContractsResult.class,
    GetClientServicesResult.class,
    GetClientReferralTypesResult.class,
    AddArrivalResult.class,
    GetRequiredClientFieldsResult.class,
    GetClientContactLogsResult.class,
    ValidateLoginResult.class,
    GetClientFormulaNotesResult.class
})
